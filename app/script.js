/* Note: This application requires that you consent to location sharing when
...
function showPanel(placeId,placeResult) {
  ...
  opening_hours.textContent = placeResult.opening_hours.weekday_text[0].replace("Monday:","").trim();
